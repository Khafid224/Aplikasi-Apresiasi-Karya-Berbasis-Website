...
if(isset($_POST['submit'])){
   ...
   $success_msg[] = 'Ulasan berhasil update!';
...
<section class="account-form">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="title" required maxlength="50" placeholder="masukkan judul ulasanmu" class="box" value="<?= $fetch_review['title']; ?>">
      <p class="placeholder">deskripsi ulasan</p>
      <textarea name="description" class="box" placeholder="masukkan ulasan deskripsimu" maxlength="1000" cols="30" rows="10"><?= $fetch_review['description']; ?></textarea>
      ...
      <input type="submit" value="update ulasan" name="submit" class="btn">
      <a href="view_post.php?get_id=<?= $fetch_review['post_id']; ?>" class="option-btn">kembali</a>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">ada yang salah!</p>';
      }
   ?>
