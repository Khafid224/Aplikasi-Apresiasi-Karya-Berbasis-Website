<header class="header">
   ...
   <section class="flex">
      ...
      <a href="all_posts.php" class="logo">Threedy.</a>
      ...
      <div class="profile">
         ...
         <a href="components/logout.php" class="delete-btn" onclick="return confirm('logout dari website ini?');">logout</a>
         <?php }else{ ?>
            <div class="flex-btn">
               <p>tolong login atau register!</p>
