...
<section class="all-posts">
   ...
   <div class="heading"><h1>semua postingan</h1></div>
   ...
   <div class="box">
      ...
      <a href="view_post.php?get_id=<?= $post_id; ?>" class="inline-btn">Tampilkan Postingan</a>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">belum ada postingan yang ditambahkan!</p>';
   }
   ?>
