...
if(isset($_POST['delete_review'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Ulasan dihapus!';
   }else{  
      $warning_msg[] = 'Ulasan berhasil dihapus!';
   }
...
<section class="view-post">
   ...
   <div class="heading"><h1>detail postingan</h1> <a href="all_posts.php" class="inline-option-btn" style="margin-top: 0;">semua postingan</a></div>
   ...
   <?php
         ...
         echo '<p class="empty">postinganya hilang!</p>';
      }
   ?>
...
<section class="reviews-container">
   ...
   <div class="heading"><h1>Ulasan Pengguna</h1> <a href="add_review.php?get_id=<?= $get_id; ?>" class="inline-btn" style="margin-top: 0;">Tambah ulasan</a></div>
   ...
   <div class="box" <?php if($fetch_review['user_id'] == $user_id){echo 'style="order: -1;"';}; ?>>
      ...
      <?php if($fetch_review['user_id'] == $user_id){ ?>
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_review.php?get_id=<?= $fetch_review['id']; ?>" class="inline-option-btn">Edit Ulasan</a>
            <input type="submit" value="Hapus Ulasan" class="inline-delete-btn" name="delete_review" onclick="return confirm('hapus ulasan ini?');">
         </form>
      <?php }; ?>   
   </div>
   <?php
         ...
         echo '<p class="empty">Belum ada tambahan ulasan!</p>';
      }
   ?>
